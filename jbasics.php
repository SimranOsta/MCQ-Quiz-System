<?php
session_start();
include 'qconnection.php'; // Ensure this file contains the correct database connection

// If it's the first question, reset session variables and fetch questions
if (!isset($_SESSION['questions']) || $_SESSION['topic'] !== 'Java Basics') {
    $_SESSION['questions'] = [];
    $_SESSION['current_question'] = 0;
    $_SESSION['score'] = 0;
    $_SESSION['topic'] = 'Java Basics'; // Set topic for session

    // Fetch 5 random questions from the "Basics" topic for Java language
    $sql = "SELECT * FROM quizzes WHERE language='Java' AND topic='Java Basics' ORDER BY RAND() LIMIT 5";
