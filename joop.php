...
// Set the correct topic in session
$_SESSION['topic'] = 'OOP';

// Reset session variables if starting a new quiz
if (!isset($_SESSION['questions']) || empty($_SESSION['questions'])) {
    $_SESSION['questions'] = [];
    $_SESSION['current_question'] = 0;
    $_SESSION['score'] = 0;

    // Fetch 5 random questions for Java OOP
    $sql = "SELECT * FROM quizzes WHERE language='Java' AND topic='OOP' ORDER BY RAND() LIMIT 5";
...
// Store the correct answer for validation in next.php
