...
if (!isset($_SESSION['topic']) || $_SESSION['topic'] != $currentTopic) {
    ...
    // Fetch 5 random questions for Java Advanced (language: Java)
    $sql = "SELECT * FROM quizzes WHERE language='Java' AND topic='Advanced' ORDER BY RAND() LIMIT 5";
...
<head>
  ...
  <title>Java Advanced Quiz</title>
  <style>
    body {
