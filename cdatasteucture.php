...
$_SESSION['topic'] = 'Data Structures';
...
if (!isset($_SESSION['questions']) || empty($_SESSION['questions'])) {
    ...
    // Fetch 5 random questions from the "C Data Structures" topic
    $sql = "SELECT * FROM quizzes WHERE language='C' AND topic='Data Structures' ORDER BY RAND() LIMIT 5";
...
// Store the correct answer in the session for next.php to validate
...
<head>
    ...
    <title>C Data Structures Quiz</title>
    <style>
        body {
