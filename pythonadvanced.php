...
if (!isset($_SESSION['topic']) || $_SESSION['topic'] != $currentTopic) {
    ...
    // Fetch 5 random questions for Python Advanced (language: Python)
    $sql = "SELECT * FROM quizzes WHERE language='Python' AND topic='Python Advanced' ORDER BY RAND() LIMIT 5";
...
<head>
  ...
  <title>Python Advanced Quiz</title>
  <style>
    body {
