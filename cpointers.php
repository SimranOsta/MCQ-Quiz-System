...
if (!isset($_SESSION['topic']) || $_SESSION['topic'] != $currentTopic) {
    // Reset session variables for new quiz session on this topic
    $_SESSION['questions'] = [];
    $_SESSION['current_question'] = 0;
    $_SESSION['score'] = 0;
    $_SESSION['topic'] = $currentTopic;
    
    // Fetch 5 random questions for C Pointers
    $sql = "SELECT * FROM quizzes WHERE language='C' AND topic='Pointers' ORDER BY RAND() LIMIT 5";
